// GET /api/perimeter/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'perimeter_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Perimeter leaderboard');
  }
}
