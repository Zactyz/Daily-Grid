// GET /api/lattice/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'lattice_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Lattice leaderboard');
  }
}
