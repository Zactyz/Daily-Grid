// GET /api/polyfit/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'polyfit_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Polyfit leaderboard');
  }
}
