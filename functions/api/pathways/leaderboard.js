// GET /api/pathways/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'pathways_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Pathways leaderboard');
  }
}
