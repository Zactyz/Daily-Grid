// GET /api/shikaku/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'shikaku_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Shikaku leaderboard');
  }
}
