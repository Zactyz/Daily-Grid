// GET /api/conduit/leaderboard?puzzleId=YYYY-MM-DD
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await fetchLeaderboard(env.DB, 'conduit_scores', puzzleId);
    return jsonOk(data);
  } catch (err) {
    return internalError(err, 'Conduit leaderboard');
  }
}
